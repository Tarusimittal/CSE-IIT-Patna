  ...
  <body>
    ...
    <div class="main-body">
          ...
          <div class="row gutters-sm">
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <a class="btn btn-info " href="licenserequest_sr.php">License Request</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              $myshops= "SELECT * from Shop where skid = '$skid'";
              $query_myshops = mysqli_query($db, $myshops);
              while($row_myshops = mysqli_fetch_assoc($query_myshops)){
                 $performa = "SELECT (sum(grade)/count(*))*10 as rating FROM `performance` 
                 WHERE sid = {$row_myshops['sid']}";
              ...
              ?>
                ...
                <div class="col-sm-4 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3"><?php echo $row_myshops['sname'];?></h6>
                      Current Rating: <?php echo $row_performance['rating'];?>
                      <div class="progress mb-3" style="height: 5px">
                        <div class="progress-bar bg-primary" role="progressbar" 
                        style="width: <?php echo $row_performance['rating'];?>%" 
    ...
    <table id = "users">
        ...
        <?php
            ...
            $query = "SELECT * FROM Shop WHERE skid=$skid";
  ...
  text-align: center;
    ...
    <table id = "users">
        ...
        <?php
            ...
            $query = "SELECT * FROM Shop WHERE DATEDIFF(licenseend,current_date) < 7 and skid='$skid'";
            $result = mysqli_query($db, $query);
            while($row = mysqli_fetch_assoc($result)){
        ?>
        <tr>
