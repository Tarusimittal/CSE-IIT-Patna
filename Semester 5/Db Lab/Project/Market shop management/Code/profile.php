    ...
    <div class="main-body">
          ...
          <div class="row gutters-sm">
            ...
            <div class="row gutters-sm">
              ...
              $myshops= "SELECT * from Shop where skid = '$var1'";
              $query_myshops = mysqli_query($db, $myshops);
              while($row_myshops = mysqli_fetch_assoc($query_myshops)){
                 $performa = "SELECT (sum(grade)/count(*))*10 as rating FROM `performance` WHERE sid = {$row_myshops['sid']}";
                ...
                <div class="col-sm-4 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      Current Rating: <?php echo $row_performance['rating']/10;?>
                      <div class="progress mb-3" style="height: 5px">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo $row_performance['rating'];?>%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
