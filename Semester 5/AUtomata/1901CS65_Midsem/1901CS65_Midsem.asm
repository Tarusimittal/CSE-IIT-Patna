...
sorting_array:
        ...
        merge_loop:
                ...
                blt $t6,$t5,compare2       #if t6<t5 then we will first store t6
...
##########  PRINTING KTH SMALLEST NUMBER  ############################
  ...
  Print1st:
    ...
    li	$t1, 0        # it will tarvel till k and output the kth smallest no of array the indexinhg is 0 based
    lw	$t3, k
    sub $t3,$t3,1
